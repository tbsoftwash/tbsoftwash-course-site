---
title: "Module 4 — House Wash: Diagnose Before You Spray (Lesson)"
track: "core"
slug: "housewash-diagnosis"
module: 4
lesson: 1
---
# Module 4 — House Wash: Diagnose Before You Spray (Lesson)

House washing is where most operators earn their reputation — good or bad.

The work itself is simple. The diagnosis is not.
This lesson teaches you to slow down for 90 seconds and identify what you’re looking at so you don’t turn oxidation, bad paint, or pre-existing damage into a callback.
...
1) **Walk the home once**. Don’t touch chemicals yet.
2) **Pick 2–3 test spots**: front + shaded side + worst area.
3) **Photo everything** (Proof Pack pre-condition).
4) **Oxidation check** (inconspicuous): wipe/rub lightly.
...
- Operator SOP: `04_sops/houses/house-wash-softwash-sop-v2.md`

...
- Safety equipment: https://www.texas-pressurewashing.com/safety-equipment
- Chemical strength chart page (downloads): https://www.texas-pressurewashing.com/chemical-strength-for-surfaces-and-materials-chart
- SH pump parts list page (download): https://www.texas-pressurewashing.com/sh-pump-parts-list
- SDS sheets page: https://www.texas-pressurewashing.com/sds-sheets

## What’s useful here (high-level)
This is a “free training library” style hub that points to:
- safety equipment list (truck standard)
- chemical strength/surface compatibility chart (laminate for crews)
- SDS library emphasis
- an SH transfer pump parts list (bulk chemical handling)

## Operator lane takeaways (how we integrate)
...
**Public-safe framing:** focus on categories (eye wash, PPE, traffic control, first aid) and when they matter.
...
## Homeowner lane takeaways (how we integrate)
### 1) DIY vs Pro decision framing
Use the existence of SDS + PPE + runoff discipline to justify:
- why hiring a pro isn’t just about “stronger chemicals”
- why we price for protection and documentation

### 2) “Surface compatibility” as the homeowner-friendly truth
Teach homeowners:
- wrong method damages siding, finishes, seals
- a pro diagnoses soil + substrate, then chooses method

## Concrete course edits to make this show up
1) Add to Module 1 Lesson 1 (Standards): “Safety loadout is part of the service.”
2) Add to Module 2 Lesson 1 (Safety-first chemicals): “SDS habit + stop conditions.”
3) Add a new printable pack page: “Truck Safety Loadout + Spill Kit”
4) Add a link block in the course site: “Operator Reference: Safety + SDS + Surface risk matrix”

...
## What’s valuable
This module is strong at:
- clear safety-first scaffolding
- equipment taxonomy (portable vs mounted, gas vs electric, belt vs direct, steam)
- measurement basics (PSI/GPM/CU) with practical constraints
- job hazard analysis prompts
...
2) **Pressure washer types diagram**
   ...
   - cold vs hot/steam
3) **PSI vs GPM tradeoff chart**
   - “more PSI isn’t always better”
   - “GPM burns water; buffer tank logic”
4) **Bypass mode heat / thermal relief valve concept**
   - trigger off → bypass circulation → heat rise → relief event
5) **Downstream injector vs softwash pump application**
   - why DS is hard to quantify
   - where it fits in the method ladder
6) **Hose ends + rolling technique**
   - male vs female end
   - drainage + over/under coiling
7) **Quick connect anatomy + safety**
...
- Module 2 (Equipment/Chemicals):
  ...
  - hose/connection discipline + field repair
- Module 11 (Ops):
  - job hazard analysis checklist
  - electrical avoidance rules + documentation
- Printables:
  - “Job Hazard Analysis (JHA) quick card”
  - “Hose + connection discipline quick card”

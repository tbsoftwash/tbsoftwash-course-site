...
## Files
- `youtube-index.json` – machine-readable list (id/title/url/kind)
- `youtube-map.md` – human mapping (which lessons should embed which videos)

## Course authoring convention
In lesson markdown, use:

- `VIDEO: https://www.youtube.com/watch?v=<id> | Optional caption`

The site renders this as an inline, glassy embed card.
